...
> Companions: `docs/technical-notes/learning-loop-reports/EXTRACTION_BENCHMARK_FINDINGS.md` (full leaderboard tables), `docs/ACQUISITION_PIPELINE.md` (current strategy), `docs/REQUIREMENTS.yaml` (REQ-043…053).
