...
flowchart TD
    ...
    G6{{"gate@6 — dispatch / dispatch approval — BUILT (manual)<br/>console: preview routed/priced package -> Approve &amp; freeze<br/>(auto mode + budget cost-gate deferred)"}}
