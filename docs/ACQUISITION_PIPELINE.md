...
**Current build state (2026-07-02):** the console runs the pipeline live through **`gate@6`** — Stage 1
...
and Stage 6 dispatch/freeze through the Stage 6→7 seam (REQ-101) — stops before the paid call. `batch_00000`
(27 curated-GT districts, `batch_type="benchmark"`, see Stage 1 below) is dispatched through Stage 5 and
ready for gate@6, reserved for Stage 7's first build. Stages 7–9 are designed, not built. Detail on each
stage's present state is in its own `STAGE*_DESIGN_2026-06.md`; the governance/DB/gate architecture that
ties them together is `PIPELINE_GOVERNANCE_AND_STATE_2026-06.md`.
