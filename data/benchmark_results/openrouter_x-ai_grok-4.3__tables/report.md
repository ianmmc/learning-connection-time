# Benchmark Report: openrouter:x-ai/grok-4.3
Run date: 2026-06-14T00:40:53
Districts tested: 40
Total extraction time: 756s (avg 18.9s/district)
...
| Grade coverage rate | 88.7% |
| False positive rate | 10.22/district |
| Mean time/extraction | 18.9s |
...
| Bangor Public Schools | ME | 25 | 30 | 83.3% |  |  |
| Albany County School District  | WY | 24 | 30 | 80.0% |  |  |
| Lewiston Public Schools | ME | 17 | 30 | 56.7% | false_positive |  |
...
| Tucson Unified District (4403) | AZ | 1 | 20 | 5.0% | false_positive, false_positive, false_positive |  |
...
| Montgomery County | AL | 0 | 30 | 0.0% | extraction_error |  |
...
| BROWARD | FL | 0 | 30 | 0.0% | false_positive, false_positive, false_positive (+115 more) |  |
...
| Washoe County | NV | 0 | 10 | 0.0% | false_positive, false_positive, false_positive (+110 more) |  |
...
Entry Scores:
  middle 08:50-15:50 → middle 08:50-15:50 | start=3/3 (Δ0m) end=3/3 (Δ0m) grade=2/2 name=0/1 conf=0/1 = 8/10
...
Penalties:
  ...
  false_positive: -3 (elementary 08:50-15:50 (Safford K-8))

Total: 10 (entries) + -9 (penalties) = 1/20 (5.0%)
...
Penalties:
  ...
  false_positive: -3 (high 08:15-14:00 (Bpt. Learning Ctr.))
...
Penalties:
  ...
  false_positive: -3 (elementary 09:00-15:15 (Barack H Obama))
  false_positive: -3 (elementary 08:35-14:50 (East Rock))
  false_positive: -3 (elementary 09:15-15:30 (Edgewood))
  false_positive: -3 (elementary 09:15-15:30 (Fair Haven))
  false_positive: -3 (elementary 08:35-14:50 (Hill Central))
  false_positive: -3 (elementary 09:15-15:30 (Hooker))
  false_positive: -3 (high 07:30-14:00 (Achievement First HS))
  false_positive: -3 (elementary 07:00-14:11 (Amistad Elem))
  false_positive: -3 (elementary 08:00-14:30 (Elm City Montessori))
  false_positive: -3 (elementary 07:30-14:05 (B. T. Washington Elem))
  false_positive: -3 (middle 07:30-14:10 (B.T. Washington Middle))
  false_positive: -3 (elementary 07:45-15:10 (Edmonds Cofield Prep))
...
Total: 7 (entries) + -118 (penalties) = 0/30 (0.0%)
...
Total: 9 (entries) + -299 (penalties) = 0/30 (0.0%)
...
Penalties:
  false_positive: -3 (high 07:50-14:50 (Cedar Rapids Comm School District))
...
Total: 25 (entries) + 0 (penalties) = 25/30 (83.3%)
...
Entry Scores:
  ...
  elementary 08:20-14:50 → elementary 08:00-14:30 | start=0/3 (Δ20m) end=0/3 (Δ20m) grade=2/2 name=0/1 conf=0/1 = 2/10

Penalties:
  false_positive: -3 (elementary 08:40-15:10 (Farwell))

Total: 20 (entries) + -3 (penalties) = 17/30 (56.7%)
...
Total: 2 (entries) + -293 (penalties) = 0/10 (0.0%)
